...
struct menu_item *menu_add_static_icon(struct menu *menu, s32 x, s32 y, gfx_texture *texture, s32 texture_tile,
                                       u32 color, f32 scale);
...
struct menu_item *menu_add_option(struct menu *menu, s32 x, s32 y, const char *options,
                                  menu_generic_callback callback_proc, void *callback_data);
struct menu_item *menu_add_option_item(struct menu *menu, s32 x, s32 y, struct vector *options,
                                  menu_generic_callback callback_proc, void *callback_data);
...
struct menu_item *menu_add_switch(struct menu *menu, s32 x, s32 y, gfx_texture *texture_on, s32 texture_tile_on,
                                  u32 color_on, gfx_texture *texture_off, s32 texture_tile_off, u32 color_off,
...
struct menu_item *menu_add_button(struct menu *menu, s32 x, s32 y, const char *name, menu_action_callback callback_proc,
                                  void *callback_data);
struct menu_item *menu_add_button_icon(struct menu *menu, s32 x, s32 y, gfx_texture *texture, s32 texture_tile,
